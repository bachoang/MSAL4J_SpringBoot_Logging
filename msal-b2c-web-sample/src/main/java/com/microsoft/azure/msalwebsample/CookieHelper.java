...
public class CookieHelper {
    ...
    static String getCookie(HttpServletRequest httpRequest, String cookieName){
        System.out.printf("%s%n", "in getCookie");
        System.out.printf("%s%n", "argument: " + cookieName);
        System.out.printf("%s%n","enumerating request cookies...");
        for(Cookie cookie : httpRequest.getCookies()){
            System.out.printf("%s%n", cookie.getName() + ":" + cookie.getValue());
